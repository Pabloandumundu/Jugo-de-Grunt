            ...
            <div class="col-lg-12">
                ...
                <div id="marcoayuda">
                    ...
                    <div id="subirftp" class="well hidden txtayuda">
                        ...
                        <p>TambiTambién, si hay archivos en el servidor que ya no están en el directorio origen serán eliminados.</p>
                    ...
                    <div id="generarsitemap" class="well hidden txtayuda">
                        ...
                        <p>Se creara un archivo sitemap.xml que contendrá referencias a todos los archivos que haya en el directorio de Desarrollo (ficheros html, imágenes, pdfs, y todo, absolutamente todo, lo demás) que se guardará en la raíz de ese mismo directorio.</p>
                    ...
                    <div id="gitpull" class="well hidden txtayuda">
                        <h3>Git Pull</h3>
                        <p>Con esta acción se descargará lo que haya sido modificado en el repositorio desde la ultima vez que se descargo (ya sea con otro pull o con clone). Pero más allá de descargar ficheros o de borrar ficheros en local si no están en el repositorio, lo que hace es integrar el código que ha cambiado en el repositorio con el código que nosotros tenemos y que a su vez hayamos podido cambiar, linea a linea.</p>
